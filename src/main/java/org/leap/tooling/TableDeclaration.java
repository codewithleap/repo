...
public class TableDeclaration {
	...
	public TableDeclaration withLocation(Location location) {
		this.location = location;
		return this;
	}
	...
	public TableDeclaration withModifiers(List<Object> modifiers) {
		this.modifiers = modifiers;
		return this;
	}
	...
	public TableDeclaration withName(String name) {
		this.name = name;
		return this;
	}
	...
	public TableDeclaration withReferences(List<Object> references) {
		this.references = references;
		return this;
	}
	...
	public TableDeclaration withType(String type) {
		this.type = type;
		return this;
	}
}