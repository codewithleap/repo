...
public class GitHubContentTests {
	...
	public void fetchContentTests(){
		String url_str = "https://api.github.com/repos/codewithleap/repo/contents/src/main/resources/org/leap/antlib.xml";
        ...
        Assert.assertEquals(gitObj.url, "https://api.github.com/repos/codewithleap/repo/contents/src/main/resources/org/leap/antlib.xml?ref=master");
